        ...
        async with httpx.AsyncClient() as client:
            try:
                if skill_id == "github.list_issues":
                    ...
                    return SkillResult(success=False, data=None, error=f"Unknown GitHub skill: {skill_id}")
        ...
        async with httpx.AsyncClient() as client:
            try:
                if skill_id == "discord.send_message":
                    ...
                    return SkillResult(success=False, data=None, error=f"Unknown Discord skill: {skill_id}")
            except httpx.HTTPStatusError as e:
